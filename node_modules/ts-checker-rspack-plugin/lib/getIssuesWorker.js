...
function useSolutionBuilder() {
    if (!solutionBuilderHost) {
        ...
        solutionBuilderHost = createWatchSolutionBuilderHost(parsedConfig, (rootNames, compilerOptions, host, oldProgram, configFileParsingDiagnostics, projectReferences)=>{
            ...
            updateDiagnostics(worker_config_config.configFile, hostDiagnostics);
        }, void 0, void 0, void 0, (builderProgram)=>{
            ...
            updateDiagnostics(programConfigFile, programConfigFile === worker_config_config.configFile ? [
                ...programDiagnostics,
                ...hostDiagnostics
            ] : programDiagnostics);
